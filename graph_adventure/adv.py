...
#random choice helper function. returns false if dead end
...
#set up initial room information and variables for custom graph
...
while check_for_question_marks(my_graph):
    ...
    if depthfirst_random_travel is False:
        ...
        print("INITIATE BREDTH FIRST SEARCH",depthfirst_random_travel,my_graph)
...
#travel to next room, get exits, update previous graph with new data,update traversal with new room id
